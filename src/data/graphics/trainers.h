...
const u32 gTrainerFrontPic_Developer[] = INCBIN_U32("graphics/trainers/front_pics/developer.4bpp.lz");
const u32 gTrainerPalette_Developer[] = INCBIN_U32("graphics/trainers/front_pics/developer.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(DEVELOPER, Developer)
};
